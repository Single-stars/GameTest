...
export const MULTIPLAYER_STATE_SYNC_MS = 33;
export const MULTIPLAYER_INPUT_KEEPALIVE_MS = 100;
export const MULTIPLAYER_REMOTE_INTERPOLATION_DELAY_MS = 80;
export const MULTIPLAYER_REMOTE_MAX_EXTRAPOLATION_MS = 140;
