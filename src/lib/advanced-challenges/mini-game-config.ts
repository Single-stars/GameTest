...
const miniAdvancedLevels: Record<MiniGameId, MiniAdvancedLevelInput[]> = {
  ...
  knife: [
    ...
    miniAdvancedLevel(2, "发射倒计时", "命中 10 发", "每发 2.5 秒倒计时，初始障碍 4 个。", { shotCount: 10, shotCountdown: 2.5, initialObstacleCount: 4 }),
    miniAdvancedLevel(3, "发射倒计时", "命中 12 发", "每发 2.0 秒倒计时，初始障碍 4 个。", { shotCount: 12, shotCountdown: 2, initialObstacleCount: 4 }),
    miniAdvancedLevel(4, "转速正弦波动", "命中 8 发", "正弦速度按 0 到正反最快循环，初始障碍 4 个。", { shotCount: 8, sineRotationEnabled: true, phaseDuration: 3, sweepPerPhase: 390, initialObstacleCount: 4 }),
    miniAdvancedLevel(5, "转速正弦波动", "命中 10 发", "正弦速度中等，初始障碍 4 个。", { shotCount: 10, sineRotationEnabled: true, phaseDuration: 2.8, sweepPerPhase: 405, initialObstacleCount: 4 }),
    miniAdvancedLevel(6, "转速正弦波动", "命中 12 发", "正弦速度更快，初始障碍 4 个。", { shotCount: 12, sineRotationEnabled: true, phaseDuration: 2.55, sweepPerPhase: 420, initialObstacleCount: 4 }),
    miniAdvancedLevel(7, "不可插区域", "命中 8 发，避开禁区", "初始障碍 4 个，1 块不可插区域，总面积约 12%。", { shotCount: 8, forbiddenZoneCount: 1, forbiddenZoneRatio: 0.12, initialObstacleCount: 4 }),
    miniAdvancedLevel(8, "不可插区域", "命中 10 发，避开禁区", "初始障碍 4 个，2 块不可插区域，总面积约 18%。", { shotCount: 10, forbiddenZoneCount: 2, forbiddenZoneRatio: 0.18, initialObstacleCount: 4 }),
    miniAdvancedLevel(9, "不可插区域", "命中 12 发，避开禁区", "3 块不可插区域，总面积约 24%。", { shotCount: 12, forbiddenZoneCount: 3, forbiddenZoneRatio: 0.24, initialObstacleCount: 3 }),
    miniAdvancedLevel(10, "综合最终关", "命中 14 发，避开禁区和旧刀", "每发 3.0 秒倒计时，正弦转速和不可插区域同时出现。", { shotCount: 14, shotCountdown: 3, sineRotationEnabled: true, phaseDuration: 2.7, sweepPerPhase: 405, forbiddenZoneCount: 2, forbiddenZoneRatio: 0.2, initialObstacleCount: 3 }),
  ],
  "square-jump": [
