...
export function getEndlessMiniGameStageConfig({
  ...
  if (miniGameId === "square-jump") {
    ...
    return {
      ...
      params: {
        ...
        movingPlatformCount: Math.round(lerp(0, 9, difficulty)),
        movingRange: Math.round(lerp(0, 58, difficulty)),
        movingSpeed: Number(lerp(0, 2.35, difficulty).toFixed(2)),
  ...
  if (miniGameId === "fall-down") {
    return {
      ...
      params: {
        ...
        movingPlatformCount: Math.round(lerp(0, 12, difficulty)),
        movingRange: Math.round(lerp(0, 86, difficulty)),
        movingSpeed: Number(lerp(0, 1.15, difficulty).toFixed(2)),
  ...
  if (miniGameId === "flappy") {
    ...
    return {
      ...
      sourceAdvancedLevel,
      params: {
        collectibleCount: Math.round(chanceAfter(difficulty, 0.28, 7)),
        ...
        movingGateSpeed: Number(lerp(1, 1.7, difficulty).toFixed(2)),
